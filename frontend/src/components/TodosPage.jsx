    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs text-slate-400 mt-0.5">פתוחות</div>
        </div>
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-4 text-center">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-2xl p-5 space-y-3">
        <h2 className="text-sm font-semibold text-slate-300">משימה חדשה</h2>
      ...
      <div className="flex gap-2 flex-wrap items-center">
        ...
        {courses.length > 0 && (
          <select
            ...
            dir="rtl"
            className="bg-slate-800 border border-slate-600 text-slate-300 text-xs rounded-full px-3 py-1 focus:outline-none focus:border-indigo-500"
          >
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16">
          ...
          {todos.length === 0 && (
            <p className="text-slate-500 text-sm mt-1">הוסף משימה ראשונה למעלה</p>
          )}
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0" dir="rtl">
                  <span className={`text-sm block leading-snug ${todo.done ? 'line-through text-slate-500' : 'text-slate-100'}`}>
                    {todo.description}
                  </span>
